        ...
        <!--div class="row">
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default" 
                    href="http://localhost/tandem/frontend/web/index.php?r=project-engineering">Engineering &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Construction</h2>
                ...
                <p><a class="btn btn-default" 
                    href="http://localhost/tandem/frontend/web/index.php?r=project-construction">Construction &raquo;</a></p>
            </div>
			<div class="col-lg-4">
                <h2>Invoice</h2>
            ...
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default" 
                    href="http://localhost/tandem/frontend/web/index.php?r=site%2Fparameters">Parameters &raquo;</a></p>
            </div>
			<div class="col-lg-4">
                <h2>Security</h2>
